export const countryData = [
  ...
  { code: 'GU', name: 'Guam', dial_code: '+1', flag: '🇬🇺' },
  ...
  { code: 'MS', name: 'Montserrat', dial_code: '+1', flag: '🇲🇸' },
  ...
  { code: 'MP', name: 'Northern Mariana Islands', dial_code: '+1', flag: '🇲🇵' },
  ...
  { code: 'TC', name: 'Turks and Caicos Islands', dial_code: '+1', flag: '🇹🇨' },
  ...
  { code: 'VG', name: 'British Virgin Islands', dial_code: '+1', flag: '🇻🇬' },
  { code: 'VI', name: 'U.S. Virgin Islands', dial_code: '+1', flag: '🇻🇮' },
